...
class WebViewTracking extends StatefulWidget {
  WebViewTracking({
    Key? key,
  }) : super(key: key);
  ...
  @override
  _WebViewTrackingState createState() => _WebViewTrackingState();
}

class _WebViewTrackingState extends State<WebViewTracking> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Builder(builder: (BuildContext context) {
        return WebView(
          initialUrl: 'https://www.shiprocket.in/shipment-tracking/',
...
// class WebViewTracking extends StatefulWidget {
//   const WebViewTracking({Key? key, this.cookieManager}) : super(key: key);
//
//   final CookieManager? cookieManager;
//
//   @override
//   State<WebViewTracking> createState() => _WebViewTrackingState();
// }
//
// class _WebViewTrackingState extends State<WebViewTracking> {
//   final Completer<WebViewController> _controller =
...
//           ),
//         ),
//         backgroundColor: MyTheme.containercolor2,
//         title: Image.asset(
//           'lib/assets/asset/guser_logo.png',
//           height: 95,
//         ),
