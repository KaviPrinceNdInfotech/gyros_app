...
class Blogss extends StatelessWidget {
  ...
  BlogListController _blogListController = Get.find();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: _blogListController.isLoading.value
            ? Center(child: CircularProgressIndicator())
            : _blogListController.blogmodel!.result!.isEmpty
                ? Center(
                    child: Text('No Data'),
                  )
                : Container(
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  padding:
                                      EdgeInsets.symmetric(horizontal: 1.3.w),
                                  child: Row(
                                    mainAxisAlignment:
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                                image: DecorationImage(
                                                    image: NetworkImage(
                                                      base +
                                                          '${_blogListController.blogmodel!.result![index].imagePath.toString()}',
                                                    ),
                                                    fit: BoxFit.cover),
                                                color: Colors.amber,
                                                borderRadius:
